...
const AdminUserDetail = () => {
	const { profileDetail, profileDetailId, profileDetails, deleteProfileAdm } =
		useAppContext()

	const navigate = useNavigate()

	useEffect(() => {
		if (profileDetailId) profileDetail()
		else return <Navigate to='/superpanel/central-dogma' />
	}, [profileDetailId])
			...
			<div className='form'>
				...
				<div className='deets-center'>
					...
					<button
						...
						onClick={() => deleteButton(profileDetailId)}
					>
						HAPUS DATA
					</button>

					<Link to='/superpanel/central-dogma' className='btn'>
						Kembali
					</Link>
				</div>
			</div>
